    ...
    >
      <div className="max-w-[1440px] mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-normal tracking-[-0.04em] leading-[0.95] mb-4 bg-gradient-to-b from-white via-blue-300 to-blue-500 bg-clip-text text-transparent light:bg-none light:text-gray-900">
        ...
        <div className="grid grid-cols-1 sm2:grid-cols-2 lg:grid-cols-3 lg2:grid-cols-4 gap-6">
          {SOLUTIONS.map((item) => (
            <Link
              ...
              className="overflow-hidden bg-gray-900/80 light:bg-white border border-gray-800 light:border-gray-200 rounded-2xl hover:border-gray-600 light:hover:border-gray-300 transition-all duration-300 flex flex-col group"
            >
              {item.image && (
